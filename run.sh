...
Show_Users_Connection_Software_Type(){
...
echo && echo -e " ocserv Panel ${Red_font_prefix}[LooPaz]${Font_color_suffix}
  -- -- --
  
 ${Green_font_prefix}0.${Font_color_suffix} Show connecting users
————————————
 ${Green_font_prefix}1.${Font_color_suffix} ocserv Panel
 ${Green_font_prefix}2.${Font_color_suffix} Abdal OCSERV MGR
————————————
...
————————————
 ...
 ${Green_font_prefix}8.${Font_color_suffix} Fix no internet
————————————
 ${Green_font_prefix} 9.${Font_color_suffix} Show Users Connection Software Type
 ${Green_font_prefix}10.${Font_color_suffix} Show connecting users
————————————
 ${Green_font_prefix}11.${Font_color_suffix} Show Free HDD
————————————" && echo
...
echo
read -e -p " Please input number [0-11]:" num
case "$num" in
    0)
    Show_connecting_users
    ;;
    ...
    ;;
    *)
    echo "Please input current number [0-11]"
    ;;
esac
